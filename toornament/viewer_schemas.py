...
class ViewerSchema:
    ...
    class Match(SchemaElement):
        ...
        def __init__(self, *, id, stage_id, group_id, round_id, number, type, status, scheduled_datetime=None,
            ...
            self.opponents = [ViewerSchema.MatchOpponent(**opponent) for opponent in opponents]
    ...
    class RankingItem(SchemaElement):
        ...
        def __init__(self, *, id, group_id, number, position, rank=None, participant=None, points, properties):
            ...
            if properties.get('score_for') and properties.get('score_against') and properties.get('score_difference'):
                self.properties = ViewerSchema.RankingItemPropertiesWithScore(**properties)
            elif properties.get('match_history'):
                self.properties = ViewerSchema.RankingItemPropertiesSwiss(**properties)
            else:
    ...
    class Tournament(SchemaElement):
        ...
        def __init__(self, *, id, discipline, name, full_name=None, status, scheduled_date_start=None,
                     ...
                     platforms,
                     logo, registration_enabled, registration_opening_datetime=None,
            ...
            self.logo = ViewerSchema.TournamentLogo(**logo) if logo else None
